...
<body style="margin:0;background:#F5F7FB;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#0A0F1C">
<div style="max-width:460px;margin:12vh auto;background:#fff;border:1px solid #E6E9F0;border-radius:16px;padding:32px;text-align:center">
  <div style="font-size:18px;font-weight:800;margin-bottom:16px">Collab<span style="color:#2C5BFF">47</span></div>
  <p style="font-size:15px;line-height:1.6;color:#42506B;margin:0 0 20px">${message}</p>
  <a href="https://collab47.com" style="display:inline-block;background:#2C5BFF;color:#fff;text-decoration:none;font-weight:600;font-size:14px;padding:10px 20px;border-radius:10px">Go to Collab47</a>
</div></body></html>`;
